...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/inheritance/interface.tmt with name sub_interface_negative
#Used extensions:
#Program:
from .Record import *
...
class ContentLengthFrontEndServer(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        obj12321 = SubInterface1()
        file = obj12321.get_value(file)
