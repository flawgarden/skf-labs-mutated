...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/collections/tuples.tmt with name tuple_as_dict_key_positive
#Used extensions:
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        ...
        tuple1 = ("aaaa",)
        tuple2 = ("bbbb",)
        my_dict = { (tuple1): pageId, (tuple2): "lbmtg" }
        pageId = my_dict[("aaaa",)]
