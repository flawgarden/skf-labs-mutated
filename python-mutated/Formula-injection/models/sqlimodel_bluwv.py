...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/decorator/decorator.tmt with name simple_class_decorator_negative 
#Used extensions: 
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        pageId = example_function_with_empty_class_wr(pageId, "ykcsd")
        db = database_con()
