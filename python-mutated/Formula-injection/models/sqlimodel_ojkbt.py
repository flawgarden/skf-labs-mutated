...
#Mutated file region: 43, null, null, null
...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/virtuality/class.tmt with name base_binary_op_positive
#Used extensions:
#Program:
from .Record import *
...
class Pages:
    ...
    def getPage(self, pageId):
        a12341 = DerivedBinaryOpClass1() if "cxaob".casefold() == "oshsk".casefold() else DerivedBinaryOpClass2()
        pageId = a12341.virtual_call("", "")
        db = database_con()
