...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/collections/tuples.tmt with name tuple_negative_index_access_positive 
#Used extensions: 
#Program:
