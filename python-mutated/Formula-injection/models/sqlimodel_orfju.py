...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/magic/magic.tmt with name magic_method_eq_positive 
#Used extensions: 
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        db = database_con()
        mc1 = MagicClass(pageId)
        mc2 = MagicClass(False)
        if mc1 == mc2:
            pageId = True
