...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/duck/typing.tmt with name duck_typing_quack_method_negative
#Used extensions:
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        db = database_con()
        duck_like = NotADuck()
        pageId = make_it_quack(duck_like, pageId)
