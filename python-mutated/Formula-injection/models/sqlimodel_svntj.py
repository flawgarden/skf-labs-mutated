...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/collections/tuples.tmt with name empty_tuple_operation_negative 
#Used extensions: 
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        ...
        if len(empty_tuple) == 0:
            empty_tuple += (pageId, True)
        pageId = empty_tuple[1]
