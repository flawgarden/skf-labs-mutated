...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/virtuality/class.tmt with name base_binary_op_negative
#Used extensions:
#Program:
from .Record import *
...
class Pages:
    ...
    def getPage(self, pageId):
        ...
        pageId = a12341.virtual_call(pageId, pageId)
        db = database_con()
