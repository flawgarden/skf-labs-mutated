...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/generics/parametrized.tmt with name get_value_from_generic_class_negative
#Used extensions:
#Program:
from .Record import *
...
class Pages:
    ...
    def getPage(self, pageId):
        genericClass12321 = GenericClass[double](0.8085912717169623)
