...
#CodeQL analysis results: [396, 563, 584]
#Semgrep analysis results: []
#Original file name: Formula-injection/models/sqlimodel.py
#Original file CWE's: [89]  
#Original file kind: fail
#Mutation info: Insert template from templates-db/languages/python/sensitivity/collections/comprehension.tmt with name simple_list_comprehension_positive 
#Used extensions: 
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        db = database_con()
        tmpList = [pageId, "hakmq", "hgynk"]
        compList = ["cobwc" + x for x in tmpList]
        pageId = compList[0]
