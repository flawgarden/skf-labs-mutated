...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/import/import.tmt with name import_string_module_from_alias_positive 
#Used extensions: 
#Program:
