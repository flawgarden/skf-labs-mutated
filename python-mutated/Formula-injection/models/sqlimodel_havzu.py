...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/field/constructors.tmt with name class_with_instance_initializer_positive
#Used extensions:
#Program:
from .Record import *
