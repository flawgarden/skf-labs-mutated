...
#Used extensions: MACRO_Create_Queue -> queue787231 = collections.deque() | MACRO_Add_EXPR_ToQueue -> queue787231.append(~[EXPR_~[TYPE@1]~]~) | MACRO_Add_EXPR_ToQueue -> queue787231.append(~[EXPR_~[TYPE@1]~]~) | MACRO_Add_Fixed_VAR_ToQueue -> queue787231.append(~[VAR_~[TYPE@1]~@1]~) | EXPR_str -> ~[EXPR_str]~ + ~[EXPR_str]~
#Program:
import collections
from .Record import *
...
class Pages:
    ...
    def getPage(self, pageId):
        ...
        queue787231.append("bembz")
        queue787231.append(pageId + pageId)
