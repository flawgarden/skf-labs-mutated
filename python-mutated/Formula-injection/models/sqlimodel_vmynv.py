...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/pm.tmt with name pattern_matching_simple_4_positive
#Used extensions:
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        db = database_con()
        pageId = simplePatternMatchingString2(pageId)
