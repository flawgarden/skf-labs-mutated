...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/collections/set.tmt with name set_add_simple_positive
#Used extensions: MACRO_Create_Set -> set787231 = set() | MACRO_Add_Fixed_VAR_ToSet -> set787231.add(~[VAR_~[TYPE@1]~@1]~)
#Program:
import collections
from .Record import *
