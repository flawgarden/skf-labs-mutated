...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/collections/comprehension.tmt with name list_comprehension_with_zip_positive
#Used extensions:
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        tmpList1 = [pageId, "yhrsi", "mphes"]
        tmpList2 = ["gesco", "doupw", "wujhr"]
