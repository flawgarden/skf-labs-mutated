sqlimodel_mnojp.py#CodeQL original results: [89, 20]
#Semgrep original results: [89, 20]
#Snyk original results: []
#-------------
#Snyk analysis results: []
#CodeQL analysis results: [396, 89, 584]
#Semgrep analysis results: [89]
#Original file name: Formula-injection/models/sqlimodel.py
#Original file CWE's: [89]  
#Original file kind: fail
#Mutation info: Insert template from templates-db/languages/python/sensitivity/none.tmt with name list_with_none_handling_negative 
#Used extensions: 
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        db = database_con()
        values = ["hlvzz", None, "hlvzz", None, pageId]
        filtered_values = [v for v in values if v is None]
        pageId = filtered_values[0]
