...
#Mutated file region: 33, null, null, null
sqlimodel_tjidb.py#Analyzer1 original results: [89, 20]
...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/decorator/decorator.tmt with name simple_function_decorator_negative
#Used extensions:
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        db = database_con()
        pageId = example_function_2(pageId, "xhkrc")
