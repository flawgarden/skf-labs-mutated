...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/varargs/varargs.tmt with name varargs_combine_strings_positive
#Used extensions: EXPR_str -> ~[EXPR_str]~ + ~[EXPR_str]~ | EXPR_str -> ~[EXPR_str]~.upper()
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        pageId = combineStrings(pageId, pageId + "nkbqy".upper())
        db = database_con()
