...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/field/nested.tmt with name nested_field_depth_3_negative
#Used extensions:
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        nested7231 = NestedFields3("defru")
        pageId = nested7231.nested1.nested1.nested1.value
        db = database_con()
