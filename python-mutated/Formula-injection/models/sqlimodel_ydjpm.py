...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/monkey/patching.tmt with name monkey_patch_class_method_negative 
#Used extensions: 
#Program:
import string
...
class Pages:
    ...
    def getPage(self, pageId):
        ...
        tmpInstance = MonkeyClass(pageId)
        pageId = tmpInstance.getArg()
