...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/decorator/decorator.tmt with name function_decorator_memoization_negative 
#Used extensions: 
#Program:
