...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/decorator/decorator.tmt with name simple_function_decorator_positive 
#Used extensions: 
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        db = database_con()
        pageId = example_function(pageId, "mgpag")
