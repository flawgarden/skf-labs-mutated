...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/virtuality/interface.tmt with name base_binary_op_interface_positive
#Used extensions:
#Program:
from .Record import *
...
def home():
    ...
    text_input = a12341.interface_call(text_input, text_input)
