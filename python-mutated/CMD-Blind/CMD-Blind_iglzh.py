...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/field/constructors.tmt with name class_with_array_initialization_by_value_negative
#Used extensions:
#Program:
from .Record import *
...
def home():
    ...
    ah = ArrayHolder(value=text_input)
    text_input = ah.values[1]
