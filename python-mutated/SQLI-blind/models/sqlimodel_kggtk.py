...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/varargs/varargs.tmt with name varargs_get_first_string_from_array_negative
#Used extensions: EXPR_str -> ~[EXPR_str]~.lower() | EXPR_str -> ~[EXPR_str]~.lower()
#Program:
...
class Pages:
    ...
    def getPage(self, pageId):
        pageId = getFirstStringFromArray("zwmeq", "kwjud".lower().lower())
        try:
            db = database_con()
