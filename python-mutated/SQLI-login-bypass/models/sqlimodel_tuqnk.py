...
class dbaccess:
    ...
    def validateUser(self, username, password):
        ...
        operators1943 = SpecialOperatorsStringHolder(query)
        srotarepo3491 = SpecialOperatorsStringHolder("sxzim")
        sum41324 = operators1943 - srotarepo3491
        query = sum41324.value
        db = database_con()
