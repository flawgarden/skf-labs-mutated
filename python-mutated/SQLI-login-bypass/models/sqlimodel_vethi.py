...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/conditional/recursion.tmt with name recursion_simple_negative
#Used extensions:
#Program:
