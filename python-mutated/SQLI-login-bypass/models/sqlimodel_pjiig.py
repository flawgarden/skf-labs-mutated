...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/field/nested.tmt with name nested_field_depth_4_array_negative
#Used extensions:
#Program:
...
class dbaccess:
    ...
    def validateUser(self, username, password):
        ...
        query = nested7231.nested1.nested1.nested1.nested1.values[0]
        db = database_con()
