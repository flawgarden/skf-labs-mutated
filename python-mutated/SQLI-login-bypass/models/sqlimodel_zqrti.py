...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/none.tmt with name none_in_function_with_two_args_negative
#Used extensions:
#Program:
...
class dbaccess:
    ...
    def validateUser(self, username, password):
        ...
        query = get_value_two_args(query)
        db = database_con()
