...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/pm.tmt with name pattern_matching_simple_4_negative
#Used extensions:
#Program:
...
class dbaccess:
    ...
    def validateUser(self, username, password):
        ...
        query = simplePatternMatchingString2("ilngn")
        db = database_con()
