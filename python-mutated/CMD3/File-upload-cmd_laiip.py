...
#Analyzer1 analysis results: [36, 99, 22, 73, 23]
#Analyzer2 analysis results: [668]
#Original file name: CMD3/File-upload-cmd.py
#Original file CWE's: [20]
#Original file kind: fail
#Mutation info: Insert template from templates-db/languages/python/sensitivity/none.tmt with name conditional_expression_none_positive
#Used extensions:
#Program:
...
def index():
    if request.method == 'POST':
        ...
        print(file)
        value = None
        file = file if value is None else False
