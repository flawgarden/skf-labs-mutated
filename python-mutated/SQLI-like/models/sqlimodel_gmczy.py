...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/decorator/decorator.tmt with name simple_class_decorator_positive
#Used extensions:
#Program:
...
class User:
    ...
    def getUser(self, username):
        db = database_con()
        username = example_function_with_class_wr(username, "svfdz")
