...
#Used extensions: EXPR_str -> ~[EXPR_str]~.replace(~[EXPR_str]~, ~[EXPR_str]~) | EXPR_str -> ~[EXPR_str]~ + ~[EXPR_str]~ | EXPR_str -> "" | EXPR_str -> ~[EXPR_str]~[~[EXPR_int]~:~[EXPR_int]~]
#Program:
from .Record import *
...
class Pages:
    ...
    def getPage(self, pageId):
        try:
            raise Exception1(pageId + pageId.replace("", "qjxsi"[-4417:pageId]))
