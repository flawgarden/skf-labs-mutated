...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/field/constructors.tmt with name class_with_array_initialization_by_value_positive
#Used extensions:
#Program:
from .Record import *
...
def home():
    ...
    #after replacements
    print("###" + ip_address)
    ah = ArrayHolder(value=ip_address)
    ip_address = ah.values[0]
