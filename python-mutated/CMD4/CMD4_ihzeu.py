...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/inheritance/class.tmt with name get_value_from_sub_sub_class_positive
#Used extensions:
#Program:
from .Record import *
...
def home():
    ...
    ip_address = ip_address.replace(";","")
    obj12321 = SubSubClass(ip_address)
    ip_address = obj12321.v
    ip_address = ip_address.replace("&","")
