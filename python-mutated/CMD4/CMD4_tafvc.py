...
#Mutated file region: 67, null, null, null
...
#Used extensions: MACRO_Create_Queue -> queue787231 = collections.deque() | MACRO_Add_EXPR_ToQueue -> queue787231.append(~[EXPR_~[TYPE@1]~]~) | MACRO_Add_EXPR_ToQueue -> queue787231.append(~[EXPR_~[TYPE@1]~]~) | MACRO_Add_Fixed_VAR_ToQueue -> queue787231.append(~[VAR_~[TYPE@1]~@1]~) | EXPR_str -> ~[EXPR_str]~.replace(~[EXPR_str]~, ~[EXPR_str]~)
#Program:
import collections
from .Record import *
...
def home():
    ...
    queue787231.append("xslmu".replace("ngnkh", "ptmxv"))
    queue787231.append("spnnv")
