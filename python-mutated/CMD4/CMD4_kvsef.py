...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/monkey/patching.tmt with name monkey_patch_class_method_with_arg_positive
#Used extensions:
#Program:
import string
...
def home():
    ...
    tmpInstance = MonkeyClass(ip_address)
    ip_address = tmpInstance.getArg("udevh")
    ip_address = ip_address.replace(";","")
    ip_address = ip_address.replace("&","")
