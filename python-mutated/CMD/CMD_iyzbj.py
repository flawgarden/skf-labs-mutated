...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/field/nested.tmt with name nested_field_depth_3_array_positive
#Used extensions:
#Program:
...
def home():
    ...
    sizeImg = nested7231.nested1.nested1.nested1.values[0]
