...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/field/nested.tmt with name nested_field_depth_4_positive
#Used extensions:
#Program:
...
def home():
    ...
    nested7231 = NestedFields4(sizeImg)
    sizeImg = nested7231.nested1.nested1.nested1.nested1.value
