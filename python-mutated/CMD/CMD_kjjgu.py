...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/field/constructors.tmt with name class_with_string_initialization_positive
#Used extensions:
#Program:
