...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/lambdas/mutation.tmt with name unary_lambda_mutation_negative
#Used extensions:
#Program:
from .Record import *
