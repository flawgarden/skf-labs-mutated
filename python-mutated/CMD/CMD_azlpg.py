...
#-------------
#Analyzer3 analysis results: [78, 489]
...
#Mutation info: Insert template from templates-db/languages/python/sensitivity/virtuality/interface.tmt with name impl_binary_op_interface_class2_positive
#Used extensions:
#Program:
from .Record import *
...
def home():
    ...
    sizeImg = a12341.interface_call("", sizeImg)
